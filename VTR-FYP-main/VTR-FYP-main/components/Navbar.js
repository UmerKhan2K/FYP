        ...
        <div className="container mx-auto flex flex-col flex-wrap items-center p-5 md:flex-row">
          <Link href={'/'}>
            <a className="title-font mb-4 flex items-center font-medium text-gray-900 md:mb-0">
              <Image src="/vtr_logo2.jpg" width={48} height={48} alt="Logo" />
              <span className="ml-3 text-xl">VTR</span>
            </a>
          </Link>
          <nav className="flex flex-wrap items-center justify-center space-x-5 text-base md:mr-auto md:ml-4 md:border-l md:border-gray-400 md:py-1 md:pl-4">
            <Link href={'/shirts'} className="mr-5">
              <a className="hover:text-gray-900">Shirts</a>
            </Link>
            <Link href={'/pants'} className="mr-5">
              <a className="hover:text-gray-900">Pants</a>
            </Link>
            <Link href={'/hoodies'} className="mr-5">
              <a className="hover:text-gray-900">Hoodies</a>
            </Link>
            <Link href={'/camera'} className="mr-5">
              <a className="hover:text-gray-900">Camera</a>
            </Link>
          </nav>
